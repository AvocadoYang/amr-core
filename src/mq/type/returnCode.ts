export enum ReturnCode {
    ...
    REGISTER_SUCCESS_AMR_NOT_REGISTER = "3332",
    REGISTER_SUCCESS_MISSION_NOT_EQUAL = "3335",
...
export const registerReturnCode = [
    ...
    ReturnCode.REGISTER_SUCCESS_AMR_NOT_REGISTER,
    ReturnCode.REGISTER_SUCCESS_MISSION_NOT_EQUAL,
    ReturnCode.NORMAL_REGISTER
]
